...
/**
 * The utility for the calendar notification template local service. This utility wraps {@link com.liferay.calendar.service.impl.CalendarNotificationTemplateLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
...
public class CalendarNotificationTemplateLocalServiceUtil {
	...
	*/
	...
	public static com.liferay.calendar.model.CalendarNotificationTemplate getCalendarNotificationTemplate(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .getCalendarNotificationTemplate(calendarId,
