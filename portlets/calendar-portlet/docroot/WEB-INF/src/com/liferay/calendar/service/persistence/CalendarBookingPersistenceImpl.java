...
public class CalendarBookingPersistenceImpl extends BasePersistenceImpl<CalendarBooking>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_C_CS = new FinderPath(CalendarBookingModelImpl.ENTITY_CACHE_ENABLED,
			CalendarBookingModelImpl.FINDER_CACHE_ENABLED,
			CalendarBookingImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByC_CS",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_C_CS = new FinderPath(CalendarBookingModelImpl.ENTITY_CACHE_ENABLED,
			CalendarBookingModelImpl.FINDER_CACHE_ENABLED,
			CalendarBookingImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByC_CS",
			new String[] { Long.class.getName(), Integer.class.getName() },
			CalendarBookingModelImpl.CALENDARID_COLUMN_BITMASK |
			CalendarBookingModelImpl.STATUS_COLUMN_BITMASK |
			CalendarBookingModelImpl.STARTTIME_COLUMN_BITMASK |
			CalendarBookingModelImpl.TITLE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_C_CS = new FinderPath(CalendarBookingModelImpl.ENTITY_CACHE_ENABLED,
			CalendarBookingModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByC_CS",
			new String[] { Long.class.getName(), Integer.class.getName() });
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_C_CS = new FinderPath(CalendarBookingModelImpl.ENTITY_CACHE_ENABLED,
			CalendarBookingModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "countByC_CS",
			new String[] { Long.class.getName(), Integer.class.getName() });
	 ...
	 */
	@Override
	public List<CalendarBooking> findByC_CS(long calendarId, int status)
		throws SystemException {
		return findByC_CS(calendarId, status, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	...
	public List<CalendarBooking> findByC_CS(long calendarId, int status,
		int start, int end) throws SystemException {
		return findByC_CS(calendarId, status, start, end, null);
	}
	...
	public List<CalendarBooking> findByC_CS(long calendarId, int status,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_C_CS;
			finderArgs = new Object[] { calendarId, status };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_C_CS;
			finderArgs = new Object[] {
					calendarId, status,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_C_CS_CALENDARID_2);

			query.append(_FINDER_COLUMN_C_CS_STATUS_2);
	 ...
	 */
	@Override
	public CalendarBooking findByC_CS_First(long calendarId, int status,
		OrderByComparator orderByComparator)
		throws NoSuchBookingException, SystemException {
		CalendarBooking calendarBooking = fetchByC_CS_First(calendarId, status,
				orderByComparator);
	 ...
	 */
	@Override
	public CalendarBooking fetchByC_CS_First(long calendarId, int status,
		OrderByComparator orderByComparator) throws SystemException {
		List<CalendarBooking> list = findByC_CS(calendarId, status, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public CalendarBooking findByC_CS_Last(long calendarId, int status,
		OrderByComparator orderByComparator)
		throws NoSuchBookingException, SystemException {
		CalendarBooking calendarBooking = fetchByC_CS_Last(calendarId, status,
				orderByComparator);
	 ...
	 */
	@Override
	public CalendarBooking fetchByC_CS_Last(long calendarId, int status,
		OrderByComparator orderByComparator) throws SystemException {
		int count = countByC_CS(calendarId, status);

		if (count == 0) {
			return null;
		}

		List<CalendarBooking> list = findByC_CS(calendarId, status, count - 1,
				count, orderByComparator);
	 ...
	 */
	@Override
	public CalendarBooking[] findByC_CS_PrevAndNext(long calendarBookingId,
		long calendarId, int status, OrderByComparator orderByComparator)
		throws NoSuchBookingException, SystemException {
		CalendarBooking calendarBooking = findByPrimaryKey(calendarBookingId);
		...
		try {
			...
			array[0] = getByC_CS_PrevAndNext(session, calendarBooking,
					calendarId, status, orderByComparator, true);

			array[1] = calendarBooking;

			array[2] = getByC_CS_PrevAndNext(session, calendarBooking,
	...
	protected CalendarBooking getByC_CS_PrevAndNext(Session session,
	 ...
	 */
	@Override
	public List<CalendarBooking> findByC_CS(long calendarId, int[] statuses)
		throws SystemException {
		return findByC_CS(calendarId, statuses, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	...
	public List<CalendarBooking> findByC_CS(long calendarId, int[] statuses,
		int start, int end) throws SystemException {
		return findByC_CS(calendarId, statuses, start, end, null);
	}
	...
	public List<CalendarBooking> findByC_CS(long calendarId, int[] statuses,
		...
		if ((statuses != null) && (statuses.length == 1)) {
			return findByC_CS(calendarId, statuses[0], start, end,
				orderByComparator);
		}
		...
		List<CalendarBooking> list = (List<CalendarBooking>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_C_CS,
				finderArgs, this);
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_C_CS_CALENDARID_5);
			...
			if ((statuses == null) || (statuses.length > 0)) {
				...
				for (int i = 0; i < statuses.length; i++) {
					query.append(_FINDER_COLUMN_C_CS_STATUS_5);
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_C_CS,
					finderArgs, list);
			}
			catch (Exception e) {
				FinderCacheUtil.removeResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_C_CS,
					finderArgs);
	 ...
	 */
	@Override
	public void removeByC_CS(long calendarId, int status)
		throws SystemException {
		for (CalendarBooking calendarBooking : findByC_CS(calendarId, status,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(calendarBooking);
		}
	}
	 ...
	 */
	@Override
	public int countByC_CS(long calendarId, int status)
		throws SystemException {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_C_CS;
	 ...
	 */
	@Override
	public int countByC_CS(long calendarId, int[] statuses)
		throws SystemException {
		Object[] finderArgs = new Object[] {
				calendarId, StringUtil.merge(statuses)
			};

		Long count = (Long)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_COUNT_BY_C_CS,
				finderArgs, this);
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_WITH_PAGINATION_COUNT_BY_C_CS,
					finderArgs, count);
			}
			catch (Exception e) {
				FinderCacheUtil.removeResult(FINDER_PATH_WITH_PAGINATION_COUNT_BY_C_CS,
					finderArgs);
	...
	private static final String _FINDER_COLUMN_C_CS_CALENDARID_2 = "calendarBooking.calendarId = ? AND ";
	private static final String _FINDER_COLUMN_C_CS_CALENDARID_5 = "(" +
		removeConjunction(_FINDER_COLUMN_C_CS_CALENDARID_2) + ")";
	private static final String _FINDER_COLUMN_C_CS_STATUS_2 = "calendarBooking.status = ?";
	private static final String _FINDER_COLUMN_C_CS_STATUS_5 = "(" +
		removeConjunction(_FINDER_COLUMN_C_CS_STATUS_2) + ")";
	...
	public CalendarBooking updateImpl(
		...
		if (isNew || !CalendarBookingModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((calendarBookingModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_C_CS.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						calendarBookingModelImpl.getOriginalCalendarId(),
						calendarBookingModelImpl.getOriginalStatus()
					};

				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_C_CS, args);
				FinderCacheUtil.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_C_CS,
					args);
