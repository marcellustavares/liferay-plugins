...
startTime = ParamUtil.getDate(request, "startTime", calendarBookingTimeZone, new Date(startTime)).getTime();
...
endTime = ParamUtil.getDate(request, "endTime", calendarBookingTimeZone, new Date(startTime)).getTime();
