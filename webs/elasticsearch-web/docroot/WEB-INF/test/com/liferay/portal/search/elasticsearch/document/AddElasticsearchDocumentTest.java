...
public class AddElasticsearchDocumentTest
extends BaseElasticsearchTest {
	...
	@Test
	public void testAddDocumentWithField() throws Exception {
	...
	@Test
	public void testAddDocumentWithLocalizableField() throws Exception {
	...
	@Test
	public void testAddDocumentWithLocalizableNestedField() throws Exception {
	...
	@Test
	public void testAddDocumentWithNestedField() throws Exception {
	...
	private void _assertAllConditions(DocumentImpl document) throws IOException
	{
		...
		String generatedJsonDocument = _generateElasticSearchJson(document
			);
		...
		String indexedJsonDocument = getIndexedJsonDocument(
