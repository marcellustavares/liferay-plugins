...
public abstract class BaseElasticsearchTest extends PowerMockito {
	...
	public void _startEmbeddedElasticsearchServer() throws Exception {

		_embeddedElasticsearchServer = createSearchServer();
	}

	public abstract EmbeddedElasticsearchServer createSearchServer()
		throws Exception;

	public abstract void doAfterRunTest();

	public abstract void doBeforeRunTest();
	...
	public void indexDocument(String indexName, String jsonDocument) {
		_embeddedElasticsearchServer.indexDocument(indexName, jsonDocument);
	}
