...
/**
 * Provides the local service interface for DynamicStorageAppEntity. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Marcellus Tavares
 * @see DynamicStorageAppEntityLocalServiceUtil
...
public interface DynamicStorageAppEntityLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DynamicStorageAppEntityLocalServiceUtil} to access the dynamic storage app entity local service. Add custom service methods to {@link com.liferay.portal.dynamicstorage.service.impl.DynamicStorageAppEntityLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
